...
import { APPLICATION_ROUTE_TEST, APPLICATION_SUCCESS_MESSAGE } from "./application.constant";
...
describe("Application endpoint", () => {
  ...
  describe("GET /api/applications", () => {
    it("should return 401 if not authenticated", async () => {
      const response = await request(app).get(APPLICATION_ROUTE_TEST.GET_APPLICATIONS);
    ...
    it("should return 403 if not an admin", async () => {
      ...
      const response = await auth.agent.get(APPLICATION_ROUTE_TEST.GET_APPLICATIONS);
  ...
  describe("GET /api/applications/:id", () => {
    it("should return 401 if not authenticated", async () => {
      const response = await request(app).get(APPLICATION_ROUTE_TEST.GET_APPLICATION(applicationId));
    ...
    it("should return 403 if not an admin", async () => {
      const auth = await authenticate();
      const response = await auth.agent.get(APPLICATION_ROUTE_TEST.GET_APPLICATION(applicationId));
    ...
    it("should return 400 when id is not valid uuid", async () => {
      const auth = await authenticate('admin');
      const response = await auth.agent.get(APPLICATION_ROUTE_TEST.GET_APPLICATION("123123"));
    ...
    it("should return 404 when application not found", async () => {
      const auth = await authenticate('admin');
      const response = await auth.agent.get(APPLICATION_ROUTE_TEST.GET_APPLICATION(invalidUuid));
  ...
  describe("POST /api/applications", () => {
    it("should return 401 if not authenticated", async () => {
      const response = await request(app).post(APPLICATION_ROUTE_TEST.CREATE_APPLICATION);
    ...
    it("should return 400 if validation fails", async () => {
      const auth = await authenticate();
      const response = await auth.agent.post(APPLICATION_ROUTE_TEST.CREATE_APPLICATION).send({});
    ...
    it("should return 200 and create application", async () => {
      ...
      const response = await auth.agent.post(APPLICATION_ROUTE_TEST.CREATE_APPLICATION).send(payload);
